...
/*   Updated: 2022/05/03 20:50:51 by myukang          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	call_upper(t_bresen *bresen_num_set, t_mlx *mlx, int color)
{
	...
	while (i < bresen_num_set->dy)
	{
		...
		mlx_pixel_put(mlx->mlx_ptr, mlx->win_ptr, bresen_num_set->x, bresen_num_set->y, color);
		i++;
	}
}
...
static void	set_bresen_nums(t_bresen *bresen_num_set, t_pixel *start, t_pixel *end)
{
